    ...
    return (
        <div className='flex flex-col'>
             <div className='text-white py-20 text-center bg-blue-700 flex justify-center items-center flex-col'>
                <h1 className='text-4xl font-bold mb-4'>Effortless Event Scheduling</h1>
                <p className='text-lg'>Plan and schedule your events with ease.</p>
                <Link to='/auth'>
            ...
            <div className='flex space-x-5'>
                <Card icon={<SlCalender className='text-yellow-600 bg-white'/>} 
